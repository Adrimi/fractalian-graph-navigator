...
private let minAllowedScale = 0.2
private let defaultScale = 1.0

struct ZoomableContainer<Content: View>: View {
    let content: Content

    @State private var currentScale: CGFloat = defaultScale
    ...
    func doubleTapAction(location: CGPoint) {
        ...
        currentScale = currentScale == defaultScale ? maxAllowedScale : defaultScale
    }
    ...
    fileprivate struct ZoomableScrollView<Content: View>: UIViewRepresentable {
        ...
        func makeUIView(context: Context) -> UIScrollView {
            ...
            scrollView.minimumZoomScale = minAllowedScale
